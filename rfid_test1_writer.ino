...
void setup() {
  ...
  lcd.begin(16, 2);  
  lcd.clear();
  Serial.println("No Master Tag! SCAN NOW!");
  lcd.setCursor(1,0);
...
void loop() {
    ...
    Serial.print("\n");
    Serial.print("Detected tagID is: ");
    Serial.println(tagID);
    ...
    if (tagID == myTags[0]) {
      ...
      Serial.println("Entered Program Mode, Add/Remove tag");
      ...
      if (tagID == myTags[0]) {
        lcd.clear();
        lcd.print("Can't Add/Remove");
        lcd.setCursor(0, 1);
        lcd.print("  Master Tag!");
        Serial.print("\n");
        Serial.println("Can't Add/Remove master Tag!");
        delay(1500);
        printNormalModeMessage();
        return;
      }
